    ...
    describe('Message Type Boundaries', () => {
      it('should handle all defined MessageType values', async () => {
        ...
        const allMessageTypes: MessageType[] = [
          'ZIP_DATA', 'UPLOAD_STATUS', 'SET_COMMIT_MESSAGE', 'DEBUG',
          'CONTENT_SCRIPT_READY', 'GITHUB_SETTINGS_CHANGED', 'OPEN_HOME',
          'OPEN_SETTINGS', 'OPEN_FILE_CHANGES', 'OPEN_ISSUES', 'OPEN_PROJECTS',
          'IMPORT_PRIVATE_REPO', 'DELETE_TEMP_REPO', 'PUSH_TO_GITHUB',
          'USE_CACHED_FILES', 'HEARTBEAT', 'HEARTBEAT_RESPONSE',
          'GITHUB_APP_SYNCED', 'SUBSCRIPTION_UPGRADED'
        ];
