  ...
  scenarios: [
    {
      ...
      preconditions: ['Chrome runtime is available', 'Valid port is provided'],
      steps: [
    ...
    },
    {
      ...
      preconditions: ['MessageHandler is initialized', 'Port is connected and healthy'],
      steps: [
    ...
    },
    {
      ...
      preconditions: ['MessageHandler is initialized', 'Port is disconnected or invalid'],
      steps: [
        'Disconnect the port',
    ...
    },
    {
      ...
      preconditions: ['Messages are queued due to disconnection', 'New valid port is available'],
      steps: [
    ...
    },
    {
      ...
      preconditions: ['MessageHandler is initialized'],
      steps: [
  ...
  scenarios: [
    {
      ...
      preconditions: ['MessageHandler is initialized and connected'],
      steps: [
    ...
    },
    {
      ...
      preconditions: ['MessageHandler is initialized with port with empty name'],
      steps: [
  ...
  scenarios: [
    {
      ...
      preconditions: ['MessageHandler is initialized with healthy port'],
      steps: [
    ...
    },
    {
      ...
      preconditions: ['MessageHandler is initialized with disconnected port'],
      steps: [
...
export const INTEGRATION_TESTS: TestCategorySpec = {
  ...
  scenarios: [
    ...
    },
    {
      ...
      preconditions: ['MessageHandler is initialized in realistic environment'],
      steps: [
