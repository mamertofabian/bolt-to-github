...
{#if show}
  <div class="p-4 bg-gradient-to-r from-blue-900/30 to-green-900/30 border border-blue-700/50 rounded-lg mb-4">
    <div class="flex items-start gap-3">
      ...
      <div class="flex-1">
        ...
        <p class="text-slate-300 mb-4">
          Get enhanced security and better performance with our new GitHub App authentication. 
