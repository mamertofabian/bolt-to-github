...
describe('RepoSettings Business Logic', () => {
  ...
  describe('handleBranchKeyboardNavigation', () => {
    const mockBranches = ['main', 'develop', 'feature/auth'];

    describe('ArrowDown key', () => {
      it('should move down without create option', () => {
        const result = handleBranchKeyboardNavigation('ArrowDown', 0, mockBranches, false);
      ...
      it('should move down with create option', () => {
        const result = handleBranchKeyboardNavigation('ArrowDown', 0, mockBranches, true);
      ...
      it('should not exceed max index', () => {
        const result = handleBranchKeyboardNavigation('ArrowDown', 2, mockBranches, false);

        expect(result.newIndex).toBe(2);
      });

      it('should not exceed max index with create option', () => {
        const result = handleBranchKeyboardNavigation('ArrowDown', 3, mockBranches, true);
    ...
    describe('ArrowUp key', () => {
      it('should move up', () => {
        const result = handleBranchKeyboardNavigation('ArrowUp', 2, mockBranches, false);
      ...
      it('should not go below -1', () => {
        const result = handleBranchKeyboardNavigation('ArrowUp', 0, mockBranches, false);

        expect(result.newIndex).toBe(-1);
      });

      it('should not go below -1 at -1', () => {
        const result = handleBranchKeyboardNavigation('ArrowUp', -1, mockBranches, false);
    ...
    describe('Enter key', () => {
      it('should close dropdown when no item selected (index -1)', () => {
        const result = handleBranchKeyboardNavigation('Enter', -1, mockBranches, false);
      ...
      it('should select branch when valid index without create option', () => {
        const result = handleBranchKeyboardNavigation('Enter', 1, mockBranches, false);
      ...
      it('should select branch when valid index with create option', () => {
        const result = handleBranchKeyboardNavigation('Enter', 1, mockBranches, true);
      ...
      it('should trigger create branch when selecting create option', () => {
        const result = handleBranchKeyboardNavigation('Enter', 0, mockBranches, true);
      ...
      it('should handle invalid index gracefully', () => {
        const result = handleBranchKeyboardNavigation('Enter', 10, mockBranches, false);
      ...
      it('should handle empty branch list', () => {
        const result = handleBranchKeyboardNavigation('Enter', 0, [], false);
    ...
    describe('Escape key', () => {
      it('should close dropdown', () => {
        const result = handleBranchKeyboardNavigation('Escape', 1, mockBranches, false);
      ...
      it('should close dropdown regardless of index', () => {
        const result = handleBranchKeyboardNavigation('Escape', -1, mockBranches, false);
    ...
    describe('Unknown key', () => {
      it('should not change state', () => {
        const result = handleBranchKeyboardNavigation('Tab', 1, mockBranches, false);
      ...
      it('should handle letter keys', () => {
        const result = handleBranchKeyboardNavigation('a', 1, mockBranches, false);
    ...
    describe('Edge cases', () => {
      it('should handle single branch without create option', () => {
        const result = handleBranchKeyboardNavigation('Enter', 0, ['main'], false);

        expect(result.selectedBranch).toBe('main');
        expect(result.shouldCloseDropdown).toBe(true);
      });

      it('should handle single branch with create option', () => {
        const result = handleBranchKeyboardNavigation('Enter', 1, ['main'], true);

        expect(result.selectedBranch).toBe('main');
        expect(result.shouldCloseDropdown).toBe(true);
      });

      it('should handle navigation from -1 to 0', () => {
        const result = handleBranchKeyboardNavigation('ArrowDown', -1, mockBranches, false);

        expect(result.newIndex).toBe(0);
      });

      it('should handle navigation from -1 to 0 with create option', () => {
        const result = handleBranchKeyboardNavigation('ArrowDown', -1, mockBranches, true);
