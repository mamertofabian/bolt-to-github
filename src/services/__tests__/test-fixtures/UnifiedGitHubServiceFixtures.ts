    ...
    page1: [
      {
        ...
        commit: {
          ...
          tree: { sha: 'tree1sha', url: 'https://api.github.com/repos/testuser/test-repo/git/trees/tree1sha' },
        ...
        author: { login: 'testuser', id: 12345678, avatar_url: 'https://avatars.githubusercontent.com/u/12345678?v=4' },
        committer: { login: 'testuser', id: 12345678, avatar_url: 'https://avatars.githubusercontent.com/u/12345678?v=4' },
        parents: [{ sha: 'parent1sha', url: 'https://api.github.com/repos/testuser/test-repo/commits/parent1sha' }]
      }
    ],
...
export const ErrorFixtures = {
  ...
  forbidden: {
    ...
    error: {
      ...
      documentation_url: 'https://docs.github.com/rest/overview/permissions-required-for-github-apps'
    }
  },
  ...
  repositoryDisabled: {
    ...
    error: {
      ...
      documentation_url: 'https://docs.github.com/rest/overview/resources-in-the-rest-api#forbidden'
    }
  },
...
export const TokenFixtures = {
  ...
  pat: {
    ...
    fineGrained: 'github_pat_11ABCDEFG0123456789_abcdefghijklmnopqrstuvwxyz1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZ',
...
export class MockAuthenticationStrategyFactory {
  ...
  constructor() {
    ...
    this.githubAppStrategy = new MockGitHubAppAuthenticationStrategy(TokenFixtures.oauth.accessToken);
  }
  ...
  mockGetIssues(owner: string, repo: string, state: string = 'open', issues?: any[]): this {
    ...
    this.responses.set(key, {
      response: {
        ok: true,
        status: 200,
        json: () => Promise.resolve(issues || (state === 'open' ? IssueFixtures.openIssues : IssueFixtures.allIssues))
      }
    });
    return this;
  }
...
export class MockChromeStorage {
  ...
  loadGitHubSettings(settings?: any): void {
    this.localStorage.set('gitHubSettings', settings || StorageFixtures.chromeStorage.githubSettings.gitHubSettings);
  }
  ...
  loadSupabaseToken(token?: string): void {
    this.localStorage.set('supabaseToken', token || StorageFixtures.chromeStorage.supabaseToken.supabaseToken);
  }
...
export class UnifiedGitHubServiceTestScenarios {
  ...
  build(): {
    ...
    const { AuthenticationStrategyFactory } = jest.requireMock('../../AuthenticationStrategyFactory');
