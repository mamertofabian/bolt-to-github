    ...
    scenarios: [
      ...
      },
      {
        ...
        setup: [
          ...
          'Sufficient API rate limit available',
        ],
        expectedBehavior: [
      ...
      },
      {
        ...
        setup: [
          'Project contains .gitignore file',
          'Some files match ignore patterns',
        ],
        expectedBehavior: [
    ...
    scenarios: [
      ...
      },
      {
        ...
        setup: [
          ...
          'User has permission to create repositories',
        ],
        expectedBehavior: [
  ...
  },
  {
    ...
    scenarios: [
      ...
      },
      {
        ...
        setup: [
          'Some files modified, some unchanged',
      ...
      },
      {
        ...
        setup: [
          'Local project has fewer files than repository',
          'Some files deleted from project',
        ],
        expectedBehavior: [
  ...
  },
  {
    ...
    scenarios: [
      ...
      },
      {
        ...
        setup: [
          'ZIP file larger than 50MB limit',
        ],
        expectedBehavior: [
    ...
    scenarios: [
      {
        ...
        setup: [
          'API rate limit is low but sufficient',
      ...
      },
      {
        ...
        edgeCases: [
          'Rate limit hit during upload',
          'Secondary rate limits triggered',
        ],
      },
      {
    ...
    scenarios: [
      {
        ...
        setup: [
          'Project ID exists but no settings',
          'Repository owner is configured',
        ],
        expectedBehavior: [
      ...
      },
      {
        ...
        setup: [
          'No repository owner configured',
  ...
  },
  {
    ...
    scenarios: [
      ...
      },
      {
        ...
        setup: [
          'Push statistics store available',
        ],
        expectedBehavior: [
  ...
  },
  {
    ...
    scenarios: [
      ...
      },
      {
        ...
        setup: [
          'Project contains images, fonts, etc.',
          'Binary data in ZIP',
        ],
        expectedBehavior: [
      ...
      },
      {
        ...
        setup: [
          'Multiple uploads triggered quickly',
