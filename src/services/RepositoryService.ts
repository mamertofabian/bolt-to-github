...
import type { IRepositoryService, RepoInfo, RepoCreateOptions, RepoSummary } from './interfaces/IRepositoryService';
...
/**
 * Helper class for handling GitHub API rate limits
 */
